...
var I18N={
  vi:{
    ...
    /* csv import modal */
    csvModalTitle:'Nhập từ file', csvEmptyT:'Mang cả lịch sử chi tiêu theo nhé', csvEmptyS:'File CSV từ ngân hàng hay app chi tiêu cũ — tụi mình đọc và tự xếp, bạn xem lại rồi mới nhập.', csvChoose:'Chọn file', csvHint:'Vietcombank · MB Bank · Money Lover · Misa · Excel', csvPickAgain:'Chọn file khác', csvSave:'Nhập',
    /* suggest modal */
