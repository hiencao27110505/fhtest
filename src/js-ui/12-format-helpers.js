...
/* Closing the picker accepts what it shows — iOS's own semantics for a date
   input, INCLUDING the today it pre-fills on an empty row (a first cut tried
   to tell that apart from a real pick; the OS cannot, and asking made it
   weird — 2026-09-14). The value was already visible in the row while the
   picker was open, and ✕ takes it back. */
