...
const TABLE = [
  ...
  ['a real-ish VCB biến-động-số-dư body is a deposit account',
    ...
    'deposit'],
  ['a 16-digit masked PAN alone proves nothing (the tiebreaker is gone)',
    { bodyText: 'GD -300,000 VND', accountMasked: '4412 34** **** 5678' },
    null],
  ['a 15-digit VIB account number is NOT a card',
    { bodyText: 'GD -300,000 VND', accountMasked: '000111222333444' },
    null],
  ['a bank account number is NOT mistaken for a card',
    { bodyText: 'GD -300,000 VND', accountMasked: '0123456789' },
    null],
  ['the ACCOUNT paying the card: dư nợ AND số dư in one mail is the account side',
    { subject: 'Thanh toán thẻ tín dụng VIB thành công',
      bodyText: ['Số tiền: 2.150.000 VND', 'Tài khoản: 000111222333444', 'Số dư: 9.850.000 VND',
                 'Thẻ: 5138 92** **** 4751', 'Dư nợ còn lại: 0 VND'].join('\n') },
    'deposit'],
