//#region ../../node_modules/.pnpm/serwist@9.5.12_browserslist@4.28.8_typescript@6.0.3/node_modules/serwist/dist/chunks/waitUntil-BDu76Zx7.js
...
//#endregion
//#region ../../node_modules/.pnpm/serwist@9.5.12_browserslist@4.28.8_typescript@6.0.3/node_modules/serwist/dist/chunks/printInstallDetails-ESDOoMBE.js
/**
...
var MAX_RETENTION_TIME$1 = 10080;
	...
	async _addRequest({ request, metadata, timestamp = Date.now() }, operation) {
		...
		switch (operation) {
			case "push":
				...
				break;
			case "unshift": await this._queueStore.unshiftEntry(entry);
		}
	...
	async _removeRequest(operation) {
		...
		switch (operation) {
			case "pop":
				...
				break;
			case "shift": entry = await this._queueStore.shiftEntry();
		}
		if (entry) {
			const maxRetentionTimeInMs = this._maxRetentionTime * 60 * 1e3;
...
var enableNavigationPreload = (headerValue) => {
	...
	else logger.log("Navigation preloading is not supported in this browser.");
};
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@serwist+utils@9.5.12_browserslist@4.28.8/node_modules/@serwist/utils/dist/index.mjs
/**
...
var CacheExpiration = class {
	...
	*/
	async isURLExpired(url) {
		if (!this._maxAgeSeconds) throw new SerwistError("expired-test-without-max-age", {
...
*/
serwist.registerRoute(new NavigationRoute(new NetworkFirst({
	cacheName: "pages",
	networkTimeoutSeconds: 10,
	plugins: [{ handlerDidError: async () => await serwist.matchPrecache(OFFLINE_URL) ?? Response.error() }]
})));
