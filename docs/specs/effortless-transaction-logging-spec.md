...
| `0143_strip_account_kind_statics` | Applied 2026-09-19. Removes the frozen `account_kind` from every stored template; the fixed `deriveAccountKind` (no PAN tiebreaker; account-side card payments read as the account) fills it per mail |
