# Build family-tab-spec.docx from family-tab-spec.md
...
SRC = os.path.join(os.path.dirname(os.path.abspath(__file__)), "family-tab-spec.md")
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "family-tab-spec.docx")
...
title_block("The Family Tab (“Gia đình”) — Shared Family Finance",
            "One place the household reads its money: what’s left, what’s promised, and what everyone thinks about it.")

# skip the md H1 title line; we re-render intro paragraphs as normal text
while i < len(lines) and not lines[i].startswith("# "):
    i += 1
i += 1  # past '# Personal Ledger...'
...
cp.title = "The Family Tab (Gia đình) — Product Specification"
cp.author = "FamilyHub"
cp.comments = ""
try:
