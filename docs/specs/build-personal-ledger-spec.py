# Build personal-ledger-spec.docx from personal-ledger-spec.md
...
SRC = os.path.join(os.path.dirname(os.path.abspath(__file__)), "personal-ledger-spec.md")
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "personal-ledger-spec.docx")
...
title_block("Personal Ledger & the “Cá nhân” Tab",
            "What each member keeps to themselves, and how the app keeps that promise.")
